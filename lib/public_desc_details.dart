...
class PublicCropDetails extends StatefulWidget {
  final String id;

  PublicCropDetails(this.id);

  @override
  State<PublicCropDetails> createState() => _PublicCropDetailsState();
}

class _PublicCropDetailsState extends State<PublicCropDetails> {
  String fullname = '';
  String climate = '';
  String image = '';
  String orgin = '';
