...
import 'package:plant_care/public_desc_details.dart';


class Publiccropdesc extends StatefulWidget {
  const Publiccropdesc ({Key? key}) : super(key: key);

  @override
  State<Publiccropdesc > createState() => _PubliccropdescState();
}

class _PubliccropdescState extends State<Publiccropdesc> {
                  ...
                  return InkWell(
                    onTap: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => PublicCropDetails(
                            documentSnapshot.id,)));
                    },
                    child: Card(
                      elevation: 10,
